...
LiquidCrystal lcd(7, 8, 9, 10, 11, 12);
 ...
 // Flag so we remember the programming button setting at the end of the cycle. 
 void setup() 
{ 
     lcd.begin(16,2);
...
{ 
  ...
  { 
    ...
    digitalWrite(greenLED, LOW);
     ...
     // and turn on the red light too so we know we're programming. 
  }  
 else 
 { 
...
{ 
  ...
  { 
     ...
     if (programButtonPressed==true)
     {
       ...
       // and the red one too if we're programming a new knock. 
     } 
     delay(knockFadeTime); 
 ...
 { 
   ...
   This makes it less picky, which while making it less secure can also make it less of a pain to use if you're tempo is a little slow or fast. */ 
   int totaltimeDifferences=0;
   int timeDiff=0;
   for (i=0;i; rejectValue)
   { 
     // Individual value too far out of whack return false; 
   } 
